...
public final class DatabaseSetup {
    ...
    public static boolean setupDatabase() {
        ...
        String password = DBConnection.getProperty("db.password", "root");
        ...
        try (Connection conn = DriverManager.getConnection(serverUrl, user, password);
            ...
            System.out.println("[setup] Creating database '" + name + "' if it does not exist ...");
            ...
            System.out.println("[setup] Database setup complete.");
            return true;

        } catch (SQLException e) {
            System.err.println("[setup] FAILED: " + e.getMessage());
            System.err.println("Check that MySQL is running and that db.properties "
                    + "has the correct host/port/user/password.");
            return false;
        }
    }
